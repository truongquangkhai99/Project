                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="summernote" class=" form-control-label">Mô tả</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <textarea name="moTa" id="summernote" rows="9" placeholder="Content..." class="form-control">${productLine.getMoTa()}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
